...
import com.bankingapp.loans.constants.LoansConstants;
import com.bankingapp.loans.dto.ErrorResponseDto;
import com.bankingapp.loans.dto.LoansContactInfoDto;
import com.bankingapp.loans.dto.LoansDto;
import com.bankingapp.loans.dto.ResponseDto;
import com.bankingapp.loans.service.LoansService;
...
@Tag(name = "CRUD REST APIs for Loans in Bank App", description = "CRUD REST APIs in Bank App to CREATE, UPDATE, FETCH AND DELETE loan details")
@RestController
...
public class LoansController {
	...
	public LoansController(LoansService iLoansService, Environment environment,
			@Value("${build.version}") String buildVersion, LoansContactInfoDto loansContactInfoDto) {
	...
	@Operation(summary = "Create Loan REST API", description = "REST API to create new loan inside Bank App")
